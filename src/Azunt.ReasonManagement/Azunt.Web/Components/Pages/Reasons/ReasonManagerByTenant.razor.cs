...
public partial class ReasonManagerByTenant : ComponentBase
{
    ...
    protected string DisplayConnectionString => string.IsNullOrWhiteSpace(TenantConnectionString)
        ...
        : TenantConnectionString.StartsWith(ReasonAppDbContextFactory.InMemoryConnectionPrefix, StringComparison.OrdinalIgnoreCase)
    ...
    {
        Nav.NavigateTo("/api/ReasonExport/ExcelByTenant", forceLoad: true);
    }
